...
var initMap = function() {
    ...
    var map,
        ...
        markerA = new google.maps.MarkerImage('/assets/pin.png',
            new google.maps.Size(24, 27),
            new google.maps.Point(0, 0),
            new google.maps.Point(12, 27)),
        markerB = new google.maps.MarkerImage('/assets/pin.png',
    ...
    function invokeEvents() {
        ...
        $Selectors.paneToggle.toggle(function(e) {
            $Selectors.dirPanel.animate({ 'left': '-=320px' });
            jQuery(this).html('&gt;');
        }, function() {
            $Selectors.dirPanel.animate({ 'left': '+=320px' });
            jQuery(this).html('&lt;');
		...
		var tryAPIGeolocation = function() {
			jQuery.post( "https://www.googleapis.com/geolocation/v1/geolocate?key=AIzaSyC6DvuNxP5cJUkj90DXqUbE0bjRuFBWJLg", function(success) {
